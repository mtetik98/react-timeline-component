...
const EventTimeline = props => {
  ...
  }, showLine && /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, showIcon && icon)), /*#__PURE__*/React__default["default"].createElement("div", {
    onClick: onCardClick,
  ...
  }, leftSideContent), /*#__PURE__*/React__default["default"].createElement("p", {
    onClick: onRightSideContentClick,
    className: `timeline-event-right-side-content font-bold ${rightSideContentClassName}`
  }, rightSideContent)), /*#__PURE__*/React__default["default"].createElement("h2", {
...
const Timeline = props => {
  ...
  const renderEventsSorted = () => {
    const events = React__default["default"].Children.toArray(children);
